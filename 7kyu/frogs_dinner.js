...
function frogContest(n) {
	...
	const sum1 = summation(n);
	const sum2 = summation(Math.floor(sum1 / 2));
	const sum3 = summation(sum1 + sum2);
	return `Chris ate ${sum1} flies, Tom ate ${sum2} flies and Cat ate ${sum3} flies`;
}
