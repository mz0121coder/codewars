...
function detectOperator(a) {
	const code = `${a}`.slice(1, 4);
	if (code === '039') return 'Golden Telecom';
	if (code === '068') return 'Beeline';
	if (/^0(63|93)$/.test(code)) return 'Life:)';
	if (/^0(67|[96-98])$/.test(code)) return 'Kyivstar';
	if (/^0(50|66|95|99)$/.test(code)) return 'MTS';
	return 'no info';
}
