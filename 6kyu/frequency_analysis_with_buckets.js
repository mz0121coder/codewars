...
define empty bucket[]
add numbers (if any) with frequency == i
if bucket is empty add null to result array
if bucket isn't empty, add bucket instead
return result
*/
...
// 			if (frequencies[num] === i) bucket.push(Number(num));
// 		}
// 		result.push(bucket.length ? bucket : null);
// 	}
// 	return result;
// }
...
console.log(bucketize([2, 2, 4, 4, 6, 6, 9, 9, 9, 9]));
console.log(bucketize([3, 3, 3, 3, 2]));
console.log(bucketize([5, 5, 5, 5, 5]));
console.log(bucketize([77, 3, 40, 40, 40]));
console.log(bucketize([16, 7, 5, 3, 6, 23]));
