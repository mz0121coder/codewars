...
function rotate(array, n) {
	const rotations = Math.abs(n) % array.length;
	if (n > 0) return [...array.slice(-rotations), ...array.slice(0, -rotations)];
	if (n < 0) return [...array.slice(rotations), ...array.slice(0, rotations)];
	return array;
}
...
console.log(rotate(data2, 7)); //, [4, 5, 1, 2, 3])
console.log(rotate(data2, 11)); //, [5, 1, 2, 3, 4])
console.log(rotate(data2, 12478)); //, [3, 4, 5, 1, 2])
