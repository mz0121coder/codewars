...
/*
define helper method to validate number:
at least 12, each neighbouring digit >= last digit, (no more than d difference)
digits can't occur more than once

loop from 12 to n, add 1 to a count for each valid number
return count
*/
...
console.log(selNumber(44, 2));
console.log(selNumber(47, 3));
console.log(selNumber(50, 3));
