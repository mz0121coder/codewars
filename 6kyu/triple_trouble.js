...
tripledouble(1222345, 12345) == 0 // num1 has straight triple 2s but num2 has only a 
single 2
...
// 		.forEach(n => {
// 			if (
// 				num1.toString().includes(n.repeat(3)) &&
// 				num2.toString().includes(n.repeat(2))
// 			) {
// 				count.push(n);
// 			}
// 		});
// 	return count.length === 0 ? 0 : 1;
// }
