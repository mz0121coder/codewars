/*Given a string that includes alphanumeric characters ("3a4B2d") return the expansion of that string: The numeric values represent the occurrence of each char preceding that numeric value. There should be no numeric characters in the final string.
...
Your code should be able to work for both lower and capital case chars.
...
const stringExpansion = s =>
	s.replace(/\d\D*/g, x => x.slice(1).replace(/./g, y => y.repeat(x[0])));
